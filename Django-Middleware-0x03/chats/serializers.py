...
class MessageSerializer(serializers.ModelSerializer):
    ...
    def validate_message_body(self, data: Message):
...
class ConversationSerializer(serializers.ModelSerializer):
    ...
    def get_total_messages(self, obj: Conversation):
        return len(obj.messages.all())  # type:ignore

    class Meta:
        model = Conversation
        fields = ('conversation_id', 'created_by', 'total_messages',
                  'created_at', 'participants_id', 'messages')
